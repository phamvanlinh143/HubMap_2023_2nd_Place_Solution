...
log_level = 'INFO'
load_from = 'workdirs/9tiles_crop128/coat_small/ds1_full_pt/swa_last.pth'
resume_from = None
workflow = [('train', 1)]
#################################################################################
...
data = dict(
    ...
    train=[train_set1, train_set2, train_set3,
           train_set4, train_set9, train_set10],
    val=val_set,
    test=test_set,
...
work_dir = 'workdirs/9tiles_crop128/coat_small/ds1_full_ft/'
