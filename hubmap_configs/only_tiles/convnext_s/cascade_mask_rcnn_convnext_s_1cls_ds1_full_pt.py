...
log_level = 'INFO'
load_from = "pretrained_weights/cascade_mask_rcnn_convnext-s_p4_w7_fpn_giou_4conv1f_fp16_ms-crop_3x_coco_20220510_201004-3d24f5a4.pth"
resume_from = None
workflow = [('train', 1)]
...
stn_aug_root = "datasets/stain_augs/"
stn_img_ext = ".tif"
...
train_set3 = dict(
        type=dataset_type,
        ann_file=data_root + 'hm_1cls/ds1/ds1_wsi1_ignore.json',
        img_prefix=data_root + 'train/',
        classes=classes,
        pipeline=train_pipeline)
...
train_set5 = dict(
        type=dataset_type,
        ann_file=data_root + 'hm_1cls/ds1/ds1_wsi2_ignore.json',
        img_prefix=data_root + 'train/',
        classes=classes,
        pipeline=train_pipeline)
...
train_set6 = dict(
        type=dataset_type,
        ann_file=data_root + 'hm_1cls/ds2/ds2_wsi1.json',
        img_prefix=data_root + 'train/',
        classes=classes,
        pipeline=train_pipeline)
...
train_set7 = dict(
        type=dataset_type,
        ann_file=data_root + 'hm_1cls/ds2/ds2_wsi2.json',
        img_prefix=data_root + 'train/',
        classes=classes,
        pipeline=train_pipeline)
...
train_set8 = dict(
        type=dataset_type,
        ann_file=data_root + 'hm_1cls/ds2/ds2_wsi3.json',
        img_prefix=data_root + 'train/',
        classes=classes,
...
train_set9 = dict(
        type=dataset_type,
        ann_file=data_root + 'hm_1cls/ds2/ds2_wsi4.json',
        img_prefix=data_root + 'train/',
        classes=classes,
        pipeline=train_same_wsi_pipeline)
...
val_set = dict(
        type=dataset_type,
        ann_file=data_root + 'hm_1cls/ds1/oof.json',
        img_prefix=data_root + 'train/',
        classes=classes,
...
data = dict(
    ...
    train=[train_set1, train_set2, train_set3,
           ...
           train_set7, train_set8, train_set9, train_set10],
    val=val_set,
    test=test_set,
...
work_dir = 'workdirs/only_tiles/convnext_s/ds1_full_pt/'
