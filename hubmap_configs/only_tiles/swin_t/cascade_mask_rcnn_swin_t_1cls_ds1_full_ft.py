...
log_level = 'INFO'
load_from = 'workdirs/only_tiles/swin_t/ds1_full_pt/swa_last.pth'
resume_from = None
workflow = [('train', 1)]
#################################################################################
...
data = dict(
    ...
    train=[train_set1, train_set2, train_set3,
           train_set4, train_set5, train_set10],
    val=val_set,
    test=test_set,
...
work_dir = 'workdirs/only_tiles/swin_t/ds1_full_ft/'
