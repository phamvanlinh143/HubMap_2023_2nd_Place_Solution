...
log_level = 'INFO'
load_from = 'pretrained_weights/cascade_mask_rcnn_swin_tiny_patch4_window7.pth'
resume_from = None
workflow = [('train', 1)]
#################################################################################
...
work_dir = 'workdirs/only_tiles/swin_t/ds1_full_pt/'
