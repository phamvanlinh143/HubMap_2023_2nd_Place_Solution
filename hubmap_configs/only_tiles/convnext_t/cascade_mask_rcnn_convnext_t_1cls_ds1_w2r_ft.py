...
log_level = 'INFO'
load_from = "workdirs/only_tiles/convnext_t/ds1_w2r_pt/swa_last.pth"
resume_from = None
workflow = [('train', 1)]
...
test_pipeline = [
    ...
    dict(
        ...
        # img_scale=(1333, 800),
        # img_scale=[(640, 640), (768, 768), (800, 800)],
...
work_dir = 'workdirs/only_tiles/convnext_t/ds1_w2r_ft/'
