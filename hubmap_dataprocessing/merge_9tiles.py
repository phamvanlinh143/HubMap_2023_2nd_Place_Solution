...
anno_root = Path("anno_9tiles")
ensure_dir(anno_root)
...
def process(ref_path, tgt_path, ignore_path, output_dir):
    ...
    data_infos = []
    jsonl_file_path = "../datasets/cleaned_polygons.jsonl"
    ...
    anno_path = anno_root.joinpath(f"merged_tile_{tgt_path.stem}.jsonl")
    save_jsonl(merged_tile_polygons, anno_path)
    

def main():
    output_dir = Path("../datasets/train_9tiles/")
    
    ref_path = Path("dataset_splits/ds1/ds1_wsi1.csv")
    tgt_path = Path("dataset_splits/ds1_kfold/ds1_wsi1_right.csv")
    ignore_path = Path("dataset_splits/ds1_kfold/ds1_wsi1_ignore.csv")
    print(tgt_path)
    process(ref_path, tgt_path, ignore_path, output_dir)

    ref_path = Path("dataset_splits/ds1/ds1_wsi1.csv")
    tgt_path = Path("dataset_splits/ds1_kfold/ds1_wsi1_left.csv")
    ignore_path = Path("dataset_splits/ds1_kfold/ds1_wsi1_ignore.csv")
    print(tgt_path)
    process(ref_path, tgt_path, ignore_path, output_dir)

    ref_path = Path("dataset_splits/ds1/ds1_wsi2.csv")
    tgt_path = Path("dataset_splits/ds1_kfold/ds1_wsi2_left.csv")
    ignore_path = Path("dataset_splits/ds1_kfold/ds1_wsi2_ignore.csv")
    print(tgt_path)
    process(ref_path, tgt_path, ignore_path, output_dir)

    ref_path = Path("dataset_splits/ds1/ds1_wsi2.csv")
    tgt_path = Path("dataset_splits/ds1_kfold/ds1_wsi2_right.csv")
    ignore_path = Path("dataset_splits/ds1_kfold/ds1_wsi2_ignore.csv")
    print(tgt_path)
    process(ref_path, tgt_path, ignore_path, output_dir)

    ref_path = Path("dataset_splits/ds1/ds1_wsi1.csv")
    tgt_path = Path("dataset_splits/ds1_kfold/ds1_wsi1_ignore.csv")
    ignore_path = None
    print(tgt_path)
    process(ref_path, tgt_path, ignore_path, output_dir)

    ref_path = Path("dataset_splits/ds1/ds1_wsi2.csv")
    tgt_path = Path("dataset_splits/ds1_kfold/ds1_wsi2_ignore.csv")
    ignore_path = None
    print(tgt_path)
    process(ref_path, tgt_path, ignore_path, output_dir)

    ref_path = Path("dataset_splits/ds2/ds2_wsi1.csv")
    tgt_path = Path("dataset_splits/ds2/ds2_wsi1.csv")
    ignore_path = None
    print(tgt_path)
    process(ref_path, tgt_path, ignore_path, output_dir)

    ref_path = Path("dataset_splits/ds2/ds2_wsi2.csv")
    tgt_path = Path("dataset_splits/ds2/ds2_wsi2.csv")
    ignore_path = None
    print(tgt_path)
    process(ref_path, tgt_path, ignore_path, output_dir)

    ref_path = Path("dataset_splits/ds2/ds2_wsi3.csv")
    tgt_path = Path("dataset_splits/ds2/ds2_wsi3.csv")
    ignore_path = None
    print(tgt_path)
    process(ref_path, tgt_path, ignore_path, output_dir)

    ref_path = Path("dataset_splits/ds2/ds2_wsi4.csv")
    tgt_path = Path("dataset_splits/ds2/ds2_wsi4.csv")
    ignore_path = None
    print(tgt_path)
    process(ref_path, tgt_path, ignore_path, output_dir)
